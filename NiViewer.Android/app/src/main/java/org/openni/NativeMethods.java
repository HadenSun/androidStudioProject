...
class NativeMethods {
	...
	static public final int AXONLINK_DEVICE_PROPERTY_GET_CAMERA_PARAMETERS = 0x60000010;//AXonLink Camera paramters
	static public final int AXONLINK_DEVICE_INVOKE_GET_UPGRADE_STATUS = 0x60000020; // AXonLinkSendFileStatus
	static public final int AXONLINK_DEVICE_INVOKE_SET_UPLOADFILE = 0x60000030;// char[]
	static public final int AXONLINK_DEVICE_INVOKE_SET_UPGRADE_ENABLE = 0x60000040; // uchar
	static public final int AXONLINK_DEVICE_INVOKE_SET_REBOOT = 0x60000080; //NULL
;

	static public final int AXONLINK_DEVICE_INVOKE_GET_FWVERSION = 0x60000160;//AxonLink_DeviceVersion
	...
	static native int oniDeviceGetFloatProperty(long deviceHandle, int propertyId,
			OutArg<Float> property);
	static native int oniDeviceGetAXonLinkFWVersionProperty(long deviceHandle, int propertyId,
			OutArg<FWVersion> property);
	static native int oniDeviceGetDriverVersion(long deviceHandle, int propertyId,OutArg<Version> property);
	static native int oniDeviceGetAXonLinkCamParamProperty(long deviceHandle, int propertyId,
			OutArg<CamParam> property);
	static native int oniDeviceGetAXonLinkSerialNumberProperty(long deviceHandle, int propertyId,
			OutArg<String> property);
	static native int oniDeviceGetIntInvoke(long deviceHandle, int commandId, OutArg<Integer> data);
	static native int oniDeviceGetBoolInvoke(long deviceHandle, int commandId, OutArg<Boolean> data);
	
	static native int oniDeviceGetFloatInvoke(long deviceHandle, int commandId, OutArg<Float> data);
		static native int oniDeviceSetIntInvoke(long deviceHandle, int commandId, int data);
	static native int oniDeviceSetBoolInvoke(long deviceHandle, int commandId, boolean data);
	
	static native int oniDeviceSetFloatInvoke(long deviceHandle, int commandId, float data);
	static native int oniDeviceUpgradeFileInvoke(long deviceHandle,String filepath);
	static native int oniDeviceGetFirmWarePacketVersion(long deviceHandle,String filename,OutArg<FirmWarePacketVersion> data);
