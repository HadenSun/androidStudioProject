...
public enum PixelFormat {
	DEPTH_1_MM(100), 		//Depth data unit: 1mm
	DEPTH_100_UM(101), 		//Depth data unit: 100um (0.1mm) 
	SHIFT_9_2(102), SHIFT_9_3(103),
	DEPTH_1_3_MM(110),		//Depth data unit: 1/3mm (0.333mm)
	// Color
